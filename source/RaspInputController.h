...
private:
    map<unsigned short, unsigned short> outputMap = {
            { VOLUME_BPM_UP_BUTTON, 2  }, { VOLUME_BPM_DOWN_BUTTON, 1  }, { MUTE_BUTTON,      3  },
            { SAMPLE1_BUTTON,     501  }, { SAMPLE2_BUTTON, 503  }, { SAMPLE3_BUTTON,     514  },
            { SAMPLE4_BUTTON,   512  }, { SAMPLE5_BUTTON,     510 }, { SAMPLE6_BUTTON, 508 }, { SAMPLE7_BUTTON,     505 },
            { SAMPLE8_BUTTON,   507 },
            { BEAT1_BUTTON,     113 }, { BEAT2_BUTTON,      109 }, { BEAT3_BUTTON,  213 },
            { BEAT4_BUTTON,     209 }, { BEAT5_BUTTON,      102 }, { BEAT6_BUTTON,  106 }, { BEAT7_BUTTON,       202 },
            { BEAT8_BUTTON,     206 },
            { BEAT13_BUTTON,      313 }, { BEAT14_BUTTON, 309 }, { BEAT15_BUTTON,      413 },
            { BEAT16_BUTTON,    409 },
            { BEAT9_BUTTON,     302 }, { BEAT10_BUTTON, 306 }, { BEAT11_BUTTON,      402 },
            { BEAT12_BUTTON,    406 },
            { START_STOP_BUTTON,  0  }
    };

    map<unsigned short, bool> buttonStateMap = {
            { VOLUME_BPM_UP_BUTTON, false }, { VOLUME_BPM_DOWN_BUTTON, false },
